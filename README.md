...
- Ubuntu via [Iconnor's PPA](https://launchpad.net/~iconnor/+archive/ubuntu/zoneminder). Please follow [these](https://wiki.zoneminder.com/Ubuntu) instructions.
...
If none of the packages above work for you and you need to build your own package, please follow [these](build_from_package.md) instructions.
