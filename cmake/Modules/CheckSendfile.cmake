...
if(SOLARIS)
    SET(CMAKE_REQUIRED_LIBRARIES -lsendfile)
endif(SOLARIS)
...
# this will never work with HAVE_SENDFILE4_SUPPORT as it is set above to 0 on fail
check_library_exists(sendfile sendfile ${SENDFILE_LIBRARIES} HAVE_SENDFILE4_SUPPORT2)
if(HAVE_SENDFILE4_SUPPORT2)
add_definitions(-DHAVE_SENDFILE4_SUPPORT=1)
unset(CMAKE_REQUIRED_DEFINITIONS)
