...
ZoneMinder",
	...
	{
        name => "ZM_OPT_EMAIL_MONITOR_CHANGES",
        default => "",
        description => "Whether to email someone when a monitor's details or function have changed.",
        help => "This function can help ensure that monitors are not accidentally or abusively altered.",
        type => $types{boolean},
        category => "mail",
    },
	{
		name => "ZM_EMAIL_MONITOR_CHANGES_TO",
		default => "",
		description => "The email address you wish your monitor change notifications to be sent to",
		requires => [ { name => "ZM_OPT_EMAIL_MONITOR_CHANGES", value => "yes" } ],
		help => "The emails or messages will be sent to this.  Must conform to RFC 2822.",
		type => $types{email},
		category => "mail",
	},
    {
