...
$event = dbFetchOne( 'select E.*,M.Name as MonitorName,M.Width,M.Height from Events as E, Monitors as M where E.Id = ? and E.MonitorId = M.Id', NULL, array($_REQUEST['eid']) );
