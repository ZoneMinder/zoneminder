package ONVIF::Analytics::Types::Dot1XConfiguration;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'Dot1XConfigurationToken' => 'ONVIF::Analytics::Types::ReferenceToken',
        ...
        'EAPMethodConfiguration' => 'ONVIF::Analytics::Types::EAPMethodConfiguration',
        'Extension' => 'ONVIF::Analytics::Types::Dot1XConfigurationExtension',
    },
    {
...
ONVIF::Analytics::Types::Dot1XConfiguration
...
Constructor. The following data structure may be passed to new():
 ...
 { # ONVIF::Analytics::Types::Dot1XConfiguration
   ...
   EAPMethodConfiguration =>  { # ONVIF::Analytics::Types::EAPMethodConfiguration
     TLSConfiguration =>  { # ONVIF::Analytics::Types::TLSConfiguration
       CertificateID =>  $some_value, # token
     },
     Password =>  $some_value, # string
     Extension =>  { # ONVIF::Analytics::Types::EapMethodExtension
     },
   },
   Extension =>  { # ONVIF::Analytics::Types::Dot1XConfigurationExtension
   },
