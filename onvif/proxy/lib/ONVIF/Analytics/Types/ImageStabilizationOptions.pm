package ONVIF::Analytics::Types::ImageStabilizationOptions;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'Mode' => 'ONVIF::Analytics::Types::ImageStabilizationMode',
...
ONVIF::Analytics::Types::ImageStabilizationOptions
