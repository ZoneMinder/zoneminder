package ONVIF::Analytics::Types::MediaCapabilities;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'StreamingCapabilities' => 'ONVIF::Analytics::Types::RealTimeStreamingCapabilities',
        'Extension' => 'ONVIF::Analytics::Types::MediaCapabilitiesExtension',
    },
    {
...
ONVIF::Analytics::Types::MediaCapabilities
...
Constructor. The following data structure may be passed to new():
 ...
 { # ONVIF::Analytics::Types::MediaCapabilities
   ...
   StreamingCapabilities =>  { # ONVIF::Analytics::Types::RealTimeStreamingCapabilities
     ...
     Extension =>  { # ONVIF::Analytics::Types::RealTimeStreamingCapabilitiesExtension
     },
   },
   Extension =>  { # ONVIF::Analytics::Types::MediaCapabilitiesExtension
     ProfileCapabilities =>  { # ONVIF::Analytics::Types::ProfileCapabilities
