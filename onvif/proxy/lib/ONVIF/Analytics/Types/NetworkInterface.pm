package ONVIF::Analytics::Types::NetworkInterface;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    },
    {
        ...
        'Info' => 'ONVIF::Analytics::Types::NetworkInterfaceInfo',
        'Link' => 'ONVIF::Analytics::Types::NetworkInterfaceLink',
        'IPv4' => 'ONVIF::Analytics::Types::IPv4NetworkInterface',
        'IPv6' => 'ONVIF::Analytics::Types::IPv6NetworkInterface',
        'Extension' => 'ONVIF::Analytics::Types::NetworkInterfaceExtension',
    },
    {
...
ONVIF::Analytics::Types::NetworkInterface
...
Constructor. The following data structure may be passed to new():
 ...
 { # ONVIF::Analytics::Types::NetworkInterface
   ...
   Link =>  { # ONVIF::Analytics::Types::NetworkInterfaceLink
     AdminSettings =>  { # ONVIF::Analytics::Types::NetworkInterfaceConnectionSetting
       AutoNegotiation =>  $some_value, # boolean
       Speed =>  $some_value, # int
       Duplex => $some_value, # Duplex
     },
     OperSettings =>  { # ONVIF::Analytics::Types::NetworkInterfaceConnectionSetting
       AutoNegotiation =>  $some_value, # boolean
       Speed =>  $some_value, # int
       Duplex => $some_value, # Duplex
     },
   ...
   Extension =>  { # ONVIF::Analytics::Types::NetworkInterfaceExtension
     ...
     Extension =>  { # ONVIF::Analytics::Types::NetworkInterfaceExtension2
     },
   },
 },
