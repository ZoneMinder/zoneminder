...
package ONVIF::Device::Elements::GetNetworkProtocolsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetNetworkProtocolsResponse');
...
GetNetworkProtocolsResponse from the namespace http://www.onvif.org/ver10/device/wsdl.
