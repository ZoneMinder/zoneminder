...
package ONVIF::Device::Elements::GetSystemBackupResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetSystemBackupResponse');
...
my %BackupFiles_of :ATTR(:get<BackupFiles>);
...
GetSystemBackupResponse from the namespace http://www.onvif.org/ver10/device/wsdl.
