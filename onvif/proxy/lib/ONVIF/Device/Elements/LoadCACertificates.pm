...
package ONVIF::Device::Elements::LoadCACertificates;
use strict;
use warnings;
...
__PACKAGE__->__set_name('LoadCACertificates');
...
ONVIF::Device::Elements::LoadCACertificates

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
LoadCACertificates from the namespace http://www.onvif.org/ver10/device/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Device::Elements::LoadCACertificates->new($data);
