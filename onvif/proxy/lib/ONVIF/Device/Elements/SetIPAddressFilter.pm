...
package ONVIF::Device::Elements::SetIPAddressFilter;
use strict;
use warnings;
...
__PACKAGE__->__set_name('SetIPAddressFilter');
...
ONVIF::Device::Elements::SetIPAddressFilter

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
SetIPAddressFilter from the namespace http://www.onvif.org/ver10/device/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Device::Elements::SetIPAddressFilter->new($data);
