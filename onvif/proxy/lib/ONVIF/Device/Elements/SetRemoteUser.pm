...
package ONVIF::Device::Elements::SetRemoteUser;
use strict;
use warnings;
...
__PACKAGE__->__set_name('SetRemoteUser');
...
ONVIF::Device::Elements::SetRemoteUser

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
SetRemoteUser from the namespace http://www.onvif.org/ver10/device/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Device::Elements::SetRemoteUser->new($data);
