...
package ONVIF::Device::Elements::SetUser;
use strict;
use warnings;
...
__PACKAGE__->__set_name('SetUser');
...
ONVIF::Device::Elements::SetUser

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
SetUser from the namespace http://www.onvif.org/ver10/device/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Device::Elements::SetUser->new($data);
