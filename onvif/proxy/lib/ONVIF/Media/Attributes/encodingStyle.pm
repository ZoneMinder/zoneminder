...
package ONVIF::Media::Attributes::encodingStyle;
use strict;
use warnings;
...
use base qw(
    ...
    ONVIF::Media::Types::encodingStyle
);
...
ONVIF::Media::Attributes::encodingStyle
...
=head2 new
 ...
 my $element = ONVIF::Media::Attributes::encodingStyle->new($data);
