...
package ONVIF::Media::Attributes::expectedContentTypes;
use strict;
use warnings;
...
ONVIF::Media::Attributes::expectedContentTypes
...
=head2 new
 ...
 my $element = ONVIF::Media::Attributes::expectedContentTypes->new($data);
