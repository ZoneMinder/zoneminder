...
package ONVIF::Media::Elements::AddAudioDecoderConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddAudioDecoderConfiguration');
...
AddAudioDecoderConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddAudioDecoderConfiguration->new($data);
