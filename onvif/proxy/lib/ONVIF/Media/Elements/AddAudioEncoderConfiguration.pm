...
package ONVIF::Media::Elements::AddAudioEncoderConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddAudioEncoderConfiguration');
...
ONVIF::Media::Elements::AddAudioEncoderConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
AddAudioEncoderConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddAudioEncoderConfiguration->new($data);
