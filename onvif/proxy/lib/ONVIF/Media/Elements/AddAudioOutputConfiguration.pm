...
package ONVIF::Media::Elements::AddAudioOutputConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddAudioOutputConfiguration');
...
AddAudioOutputConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddAudioOutputConfiguration->new($data);
