...
package ONVIF::Media::Elements::AddAudioSourceConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddAudioSourceConfiguration');
...
ONVIF::Media::Elements::AddAudioSourceConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
AddAudioSourceConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddAudioSourceConfiguration->new($data);
