...
package ONVIF::Media::Elements::AddMetadataConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddMetadataConfiguration');
...
ONVIF::Media::Elements::AddMetadataConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
AddMetadataConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddMetadataConfiguration->new($data);
