...
package ONVIF::Media::Elements::AddVideoAnalyticsConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddVideoAnalyticsConfiguration');
...
ONVIF::Media::Elements::AddVideoAnalyticsConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
AddVideoAnalyticsConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddVideoAnalyticsConfiguration->new($data);
