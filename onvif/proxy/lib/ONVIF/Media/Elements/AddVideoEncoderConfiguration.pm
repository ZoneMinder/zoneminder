...
package ONVIF::Media::Elements::AddVideoEncoderConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('AddVideoEncoderConfiguration');
...
AddVideoEncoderConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AddVideoEncoderConfiguration->new($data);
