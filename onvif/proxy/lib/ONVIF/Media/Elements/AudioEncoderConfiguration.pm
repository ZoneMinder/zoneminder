...
package ONVIF::Media::Elements::AudioEncoderConfiguration;
use strict;
use warnings;
...
use base qw(
    ...
    ONVIF::Media::Types::AudioEncoderConfiguration
);
...
ONVIF::Media::Elements::AudioEncoderConfiguration
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AudioEncoderConfiguration->new($data);
