...
package ONVIF::Media::Elements::AudioSourceConfiguration;
use strict;
use warnings;
...
ONVIF::Media::Elements::AudioSourceConfiguration
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::AudioSourceConfiguration->new($data);
