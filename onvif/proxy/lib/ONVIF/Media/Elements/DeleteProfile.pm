...
package ONVIF::Media::Elements::DeleteProfile;
use strict;
use warnings;
...
__PACKAGE__->__set_name('DeleteProfile');
...
ONVIF::Media::Elements::DeleteProfile

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
DeleteProfile from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::DeleteProfile->new($data);
