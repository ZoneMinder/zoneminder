...
package ONVIF::Media::Elements::GetAudioDecoderConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioDecoderConfiguration');
...
GetAudioDecoderConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetAudioDecoderConfiguration->new($data);
