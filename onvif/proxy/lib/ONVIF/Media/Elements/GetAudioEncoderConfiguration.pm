...
package ONVIF::Media::Elements::GetAudioEncoderConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioEncoderConfiguration');
...
GetAudioEncoderConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetAudioEncoderConfiguration->new($data);
