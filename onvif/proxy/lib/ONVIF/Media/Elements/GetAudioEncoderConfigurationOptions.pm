...
package ONVIF::Media::Elements::GetAudioEncoderConfigurationOptions;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioEncoderConfigurationOptions');
...
GetAudioEncoderConfigurationOptions from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetAudioEncoderConfigurationOptions->new($data);
