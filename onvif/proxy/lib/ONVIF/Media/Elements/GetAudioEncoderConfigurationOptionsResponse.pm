...
package ONVIF::Media::Elements::GetAudioEncoderConfigurationOptionsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioEncoderConfigurationOptionsResponse');
...
GetAudioEncoderConfigurationOptionsResponse from the namespace http://www.onvif.org/ver10/media/wsdl.
