...
package ONVIF::Media::Elements::GetAudioOutputConfigurationOptions;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioOutputConfigurationOptions');
...
ONVIF::Media::Elements::GetAudioOutputConfigurationOptions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetAudioOutputConfigurationOptions from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetAudioOutputConfigurationOptions->new($data);
