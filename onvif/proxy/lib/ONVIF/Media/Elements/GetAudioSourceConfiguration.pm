...
package ONVIF::Media::Elements::GetAudioSourceConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioSourceConfiguration');
...
ONVIF::Media::Elements::GetAudioSourceConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetAudioSourceConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetAudioSourceConfiguration->new($data);
