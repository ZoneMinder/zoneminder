...
package ONVIF::Media::Elements::GetAudioSourceConfigurationOptions;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetAudioSourceConfigurationOptions');
...
ONVIF::Media::Elements::GetAudioSourceConfigurationOptions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetAudioSourceConfigurationOptions from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetAudioSourceConfigurationOptions->new($data);
