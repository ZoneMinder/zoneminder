...
package ONVIF::Media::Elements::GetCompatibleAudioDecoderConfigurations;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetCompatibleAudioDecoderConfigurations');
...
GetCompatibleAudioDecoderConfigurations from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetCompatibleAudioDecoderConfigurations->new($data);
