...
package ONVIF::Media::Elements::GetCompatibleAudioEncoderConfigurations;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetCompatibleAudioEncoderConfigurations');
...
GetCompatibleAudioEncoderConfigurations from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetCompatibleAudioEncoderConfigurations->new($data);
