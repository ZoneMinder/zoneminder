...
package ONVIF::Media::Elements::GetCompatibleVideoAnalyticsConfigurations;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetCompatibleVideoAnalyticsConfigurations');
...
GetCompatibleVideoAnalyticsConfigurations from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetCompatibleVideoAnalyticsConfigurations->new($data);
