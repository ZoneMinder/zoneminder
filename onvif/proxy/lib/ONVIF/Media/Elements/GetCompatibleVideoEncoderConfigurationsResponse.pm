...
package ONVIF::Media::Elements::GetCompatibleVideoEncoderConfigurationsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetCompatibleVideoEncoderConfigurationsResponse');
...
ONVIF::Media::Elements::GetCompatibleVideoEncoderConfigurationsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetCompatibleVideoEncoderConfigurationsResponse from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetCompatibleVideoEncoderConfigurationsResponse->new($data);
