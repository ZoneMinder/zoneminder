...
package ONVIF::Media::Elements::GetCompatibleVideoSourceConfigurationsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetCompatibleVideoSourceConfigurationsResponse');
...
ONVIF::Media::Elements::GetCompatibleVideoSourceConfigurationsResponse

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetCompatibleVideoSourceConfigurationsResponse from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetCompatibleVideoSourceConfigurationsResponse->new($data);
