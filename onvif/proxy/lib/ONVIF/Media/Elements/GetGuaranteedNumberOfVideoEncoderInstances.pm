...
package ONVIF::Media::Elements::GetGuaranteedNumberOfVideoEncoderInstances;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetGuaranteedNumberOfVideoEncoderInstances');
...
GetGuaranteedNumberOfVideoEncoderInstances from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetGuaranteedNumberOfVideoEncoderInstances->new($data);
