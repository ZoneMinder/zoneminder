...
package ONVIF::Media::Elements::GetMetadataConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetMetadataConfiguration');
...
ONVIF::Media::Elements::GetMetadataConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetMetadataConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetMetadataConfiguration->new($data);
