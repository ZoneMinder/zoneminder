...
package ONVIF::Media::Elements::GetOSDOptions;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetOSDOptions');
...
ONVIF::Media::Elements::GetOSDOptions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetOSDOptions from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetOSDOptions->new($data);
