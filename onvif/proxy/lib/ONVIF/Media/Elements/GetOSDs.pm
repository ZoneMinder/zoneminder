...
package ONVIF::Media::Elements::GetOSDs;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetOSDs');
...
ONVIF::Media::Elements::GetOSDs

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetOSDs from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetOSDs->new($data);
