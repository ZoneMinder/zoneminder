...
package ONVIF::Media::Elements::GetSnapshotUri;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetSnapshotUri');
...
ONVIF::Media::Elements::GetSnapshotUri

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetSnapshotUri from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetSnapshotUri->new($data);
