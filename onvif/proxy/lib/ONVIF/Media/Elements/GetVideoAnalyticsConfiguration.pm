...
package ONVIF::Media::Elements::GetVideoAnalyticsConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetVideoAnalyticsConfiguration');
...
ONVIF::Media::Elements::GetVideoAnalyticsConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetVideoAnalyticsConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetVideoAnalyticsConfiguration->new($data);
