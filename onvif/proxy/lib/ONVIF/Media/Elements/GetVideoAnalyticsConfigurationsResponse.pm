...
package ONVIF::Media::Elements::GetVideoAnalyticsConfigurationsResponse;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetVideoAnalyticsConfigurationsResponse');
...
GetVideoAnalyticsConfigurationsResponse from the namespace http://www.onvif.org/ver10/media/wsdl.
