...
package ONVIF::Media::Elements::GetVideoEncoderConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetVideoEncoderConfiguration');
...
ONVIF::Media::Elements::GetVideoEncoderConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetVideoEncoderConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetVideoEncoderConfiguration->new($data);
