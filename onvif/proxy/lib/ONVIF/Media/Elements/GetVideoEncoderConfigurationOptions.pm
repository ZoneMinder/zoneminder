...
package ONVIF::Media::Elements::GetVideoEncoderConfigurationOptions;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetVideoEncoderConfigurationOptions');
...
ONVIF::Media::Elements::GetVideoEncoderConfigurationOptions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetVideoEncoderConfigurationOptions from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetVideoEncoderConfigurationOptions->new($data);
