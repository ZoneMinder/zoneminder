...
package ONVIF::Media::Elements::GetVideoSourceConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetVideoSourceConfiguration');
...
GetVideoSourceConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetVideoSourceConfiguration->new($data);
