...
package ONVIF::Media::Elements::GetVideoSourceConfigurationOptions;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetVideoSourceConfigurationOptions');
...
ONVIF::Media::Elements::GetVideoSourceConfigurationOptions

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetVideoSourceConfigurationOptions from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::GetVideoSourceConfigurationOptions->new($data);
