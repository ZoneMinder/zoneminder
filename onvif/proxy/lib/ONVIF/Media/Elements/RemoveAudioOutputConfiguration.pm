...
package ONVIF::Media::Elements::RemoveAudioOutputConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('RemoveAudioOutputConfiguration');
...
RemoveAudioOutputConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::RemoveAudioOutputConfiguration->new($data);
