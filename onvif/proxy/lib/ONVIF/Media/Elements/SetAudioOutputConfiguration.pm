...
package ONVIF::Media::Elements::SetAudioOutputConfiguration;
use strict;
use warnings;
...
__PACKAGE__->__set_name('SetAudioOutputConfiguration');
...
ONVIF::Media::Elements::SetAudioOutputConfiguration

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
SetAudioOutputConfiguration from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::SetAudioOutputConfiguration->new($data);
