...
package ONVIF::Media::Elements::StopMulticastStreaming;
use strict;
use warnings;
...
__PACKAGE__->__set_name('StopMulticastStreaming');
...
StopMulticastStreaming from the namespace http://www.onvif.org/ver10/media/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::StopMulticastStreaming->new($data);
