...
package ONVIF::Media::Elements::VideoEncoderConfiguration;
use strict;
use warnings;
...
use base qw(
    ...
    ONVIF::Media::Types::VideoEncoderConfiguration
);
...
=head2 new
 ...
 my $element = ONVIF::Media::Elements::VideoEncoderConfiguration->new($data);
