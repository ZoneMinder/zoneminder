...
package ONVIF::PTZ::Attributes::encodingStyle;
use strict;
use warnings;
...
ONVIF::PTZ::Attributes::encodingStyle
...
=head2 new
 ...
 my $element = ONVIF::PTZ::Attributes::encodingStyle->new($data);
