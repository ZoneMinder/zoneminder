...
package ONVIF::PTZ::Elements::CreatePresetTour;
use strict;
use warnings;
...
__PACKAGE__->__set_name('CreatePresetTour');
...
ONVIF::PTZ::Elements::CreatePresetTour

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
CreatePresetTour from the namespace http://www.onvif.org/ver20/ptz/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::PTZ::Elements::CreatePresetTour->new($data);
