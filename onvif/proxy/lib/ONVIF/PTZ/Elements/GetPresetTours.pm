...
package ONVIF::PTZ::Elements::GetPresetTours;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetPresetTours');
...
ONVIF::PTZ::Elements::GetPresetTours

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetPresetTours from the namespace http://www.onvif.org/ver20/ptz/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::PTZ::Elements::GetPresetTours->new($data);
