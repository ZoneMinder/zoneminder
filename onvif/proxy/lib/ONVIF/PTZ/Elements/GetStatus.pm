...
package ONVIF::PTZ::Elements::GetStatus;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GetStatus');
...
ONVIF::PTZ::Elements::GetStatus

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GetStatus from the namespace http://www.onvif.org/ver20/ptz/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::PTZ::Elements::GetStatus->new($data);
