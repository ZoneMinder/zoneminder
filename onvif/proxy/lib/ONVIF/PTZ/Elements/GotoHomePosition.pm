...
package ONVIF::PTZ::Elements::GotoHomePosition;
use strict;
use warnings;
...
__PACKAGE__->__set_name('GotoHomePosition');
...
ONVIF::PTZ::Elements::GotoHomePosition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
GotoHomePosition from the namespace http://www.onvif.org/ver20/ptz/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::PTZ::Elements::GotoHomePosition->new($data);
