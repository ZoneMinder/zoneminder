...
package ONVIF::PTZ::Elements::SetHomePosition;
use strict;
use warnings;
...
__PACKAGE__->__set_name('SetHomePosition');
...
ONVIF::PTZ::Elements::SetHomePosition

=head1 DESCRIPTION

Perl data type class for the XML Schema defined element
SetHomePosition from the namespace http://www.onvif.org/ver20/ptz/wsdl.
...
=head2 new
 ...
 my $element = ONVIF::PTZ::Elements::SetHomePosition->new($data);
