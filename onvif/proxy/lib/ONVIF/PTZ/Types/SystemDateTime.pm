package ONVIF::PTZ::Types::SystemDateTime;
use strict;
use warnings;
...
__PACKAGE__->_factory(
    ...
    {
        'DateTimeType' => 'ONVIF::PTZ::Types::SetDateTimeType',
        'DaylightSavings' => 'SOAP::WSDL::XSD::Typelib::Builtin::boolean',
        'TimeZone' => 'ONVIF::PTZ::Types::TimeZone',
        'UTCDateTime' => 'ONVIF::PTZ::Types::DateTime',
        'LocalDateTime' => 'ONVIF::PTZ::Types::DateTime',
        'Extension' => 'ONVIF::PTZ::Types::SystemDateTimeExtension',
    },
    {
...
Constructor. The following data structure may be passed to new():
 ...
 { # ONVIF::PTZ::Types::SystemDateTime
   ...
   UTCDateTime =>  { # ONVIF::PTZ::Types::DateTime
     Time =>  { # ONVIF::PTZ::Types::Time
       Hour =>  $some_value, # int
       Minute =>  $some_value, # int
       Second =>  $some_value, # int
     },
     Date =>  { # ONVIF::PTZ::Types::Date
       Year =>  $some_value, # int
