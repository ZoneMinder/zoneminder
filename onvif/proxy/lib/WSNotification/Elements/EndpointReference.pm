...
package WSNotification::Elements::EndpointReference;
use strict;
use warnings;
...
WSNotification::Elements::EndpointReference
...
=head2 new
 ...
 my $element = WSNotification::Elements::EndpointReference->new($data);
