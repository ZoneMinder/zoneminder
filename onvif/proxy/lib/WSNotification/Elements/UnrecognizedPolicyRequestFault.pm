...
package WSNotification::Elements::UnrecognizedPolicyRequestFault;
use strict;
use warnings;
...
__PACKAGE__->__set_name('UnrecognizedPolicyRequestFault');
...
UnrecognizedPolicyRequestFault from the namespace http://docs.oasis-open.org/wsn/b-2.
