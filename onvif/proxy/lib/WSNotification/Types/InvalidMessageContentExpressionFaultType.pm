package WSNotification::Types::InvalidMessageContentExpressionFaultType;
use strict;
use warnings;
...
InvalidMessageContentExpressionFaultType from the namespace http://docs.oasis-open.org/wsn/b-2.
