package WSNotification::Types::InvalidProducerPropertiesExpressionFaultType;
use strict;
use warnings;
...
InvalidProducerPropertiesExpressionFaultType from the namespace http://docs.oasis-open.org/wsn/b-2.
