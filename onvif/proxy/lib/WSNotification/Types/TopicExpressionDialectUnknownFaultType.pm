package WSNotification::Types::TopicExpressionDialectUnknownFaultType;
use strict;
use warnings;
...
TopicExpressionDialectUnknownFaultType from the namespace http://docs.oasis-open.org/wsn/b-2.
