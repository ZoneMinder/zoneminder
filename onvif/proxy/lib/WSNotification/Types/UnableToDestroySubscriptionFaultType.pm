package WSNotification::Types::UnableToDestroySubscriptionFaultType;
use strict;
use warnings;
...
UnableToDestroySubscriptionFaultType from the namespace http://docs.oasis-open.org/wsn/b-2.
