...
class ONVIF {
 ...
 protected:
  ...
  SystemTimePoint subscription_termination_time;  // When the subscription will terminate
  SystemTimePoint subscription_renewal_time;      // When to perform next renewal (termination - 10s)
  ...
  void update_subscription_times(time_t termination_time);  // Update termination and renewal times
#endif
