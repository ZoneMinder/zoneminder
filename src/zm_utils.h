...
// Reduce an IP address to its network prefix for IP-bound auth hashing: IPv4 is
// masked to /24, IPv6 to /64. Returns a lowercase hex string of the masked
// address bytes, byte-for-byte identical to the PHP authNetworkPrefix() in
// web/includes/Network.php so a hash generated by the web side validates here.
