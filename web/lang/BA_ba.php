...
// ZoneMinder Bosnian Translation by Damir Merdan (merdan.damir@gmial.com)
...
$SLANG = array(
    ...
    'AlarmFrameCount'       => 'Alarm broj slicica',
    ...
    'CaptureHeight'         => 'Snimi visinu',
    'CaptureMethod'         => 'Snimi metodu',
    'CaptureResolution'     => 'Snimi rezoluciju',
    'CapturePalette'        => 'Snimi paletu',
    'CaptureWidth'          => 'Snimi širinu',
    'Cause'                 => 'Uzrok',
    ...
    'Description'           => 'Opis',
    'DetectedCameras'       => 'Izbrisane kamere',
    'DetectedProfiles'      => 'Otkriveni profili',
    'DeviceChannel'         => 'Kanal',
    'DeviceFormat'          => 'Format uređaja',
    ...
    'ErrorBrackets'         => 'Greška, provjerite dali imate jednak broj otvorenih i zatvorenih zagrada.',
    'Error'                 => 'Greška',
    ...
    'MonitorProbeIntro'     => 'Donji popis prikazuje otkrivene analogne i mrežne kamere, te dali se iste već koriste i dali su dostupne.<br/><br/>Odaberite željenu kameru sa donjeg popisa.<br/><br/>Please note that not all cameras may be detected and that choosing a camera here may overwrite any values you already have configured for the current monitor.<br/><br/>',
    ...
    'SetNewBandwidth'       => 'Postavi novu propusnost',
    ...
    'Submit'                => 'Pošalji',
    'System'                => 'Sistem',
    'TargetColorspace'      => 'Ciljano podučje boja',
    'Tele'                  => 'Udaljeno',
    'Thumbnail'             => 'Slicica',
    'Tilt'                  => 'Tilt',
    ...
    'ViewEvent'             => 'Pregled dogadjaja',
    'ViewPaged'             => 'Stanicni pregled',
    'View'                  => 'Pregled',
	'V4L'					=> 'V4L',
    ...
    'White'                 => 'Bijelo',
    'Wide'                  => 'Široko',
    'X10ActivationString'   => 'X10 znakoni niz za aktiviranje',
