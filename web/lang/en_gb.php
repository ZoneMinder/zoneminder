...
$SLANG = array(
   ...
   <ul>
    ...
    'AudioDetection'            => 'Score the monitor on how loud its audio is, alongside motion.',
    'AudioThreshold'            => 'Audio level, 0-100, at or above which the monitor alarms. 0 turns audio detection off.',
    'AudioAlarmScore'           => 'Score contributed to a frame while the audio level is over the threshold.',
    ...
    'RemoteRtspDeprecated'      => 'ZoneMinder\'s own RTSP support is deprecated and will be removed. Change this monitor to Type Ffmpeg, putting the full rtsp:// URL in Source Path. The capture log names the exact URL to use.',
