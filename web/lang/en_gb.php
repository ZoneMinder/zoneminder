...
$SLANG = array(
    ...
    'PrivacyContactText'    => 'There are three primary ways to engage with the community:<ul><li>The user forum at forums.zoneminder.com</li><li>The ZoneMinder Slack channel</li><li>A github forum exists for bug reporting only</li></ul>',
    ...
    'PrivacyTelemetryList'  => 'The ZoneMinder Telemetry daemon collects the following data about your system:<ul><li>A unique identifier<li>City based location including: city, region, country, latitude, and longitude<li>Current time<li>Total number of monitors<li>Total number of events<li>System architecture<li>Operating system kernel, distro, and distro version<li>Version of ZoneMinder<li>Total amount of memory<li>Number of cpu cores<li>The following configuration parameters from each monitor are collected:<ul><li>Id<li>Name<li>Type<li>Function<li>Width<li>Height<li>Colours<li>MaxFPS<li>AlarmMaxFPS</ul></ul>',
    'PrivacyConclusionText' => 'We are <u>NOT</u> collecting any image specific data from your cameras. We don’t know what your cameras are watching. This data will not be sold or used for any purpose not stated herein.<br/>By clicking accept, you agree to send us this data to help make ZoneMinder a better product. By clicking decline, you can still freely use ZoneMinder and all its features.',
    'PrivacyBadSelection'   => 'Please select either accept or decline.',
    'Probe'                 => 'Probe',
