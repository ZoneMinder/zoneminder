...
$SLANG = array(
    ...
    'AttrWeekday'          => 'Semaine',
    'Auto'                 => 'Auto',
    'AutoStopTimeout'      => 'Tempo. arrêt auto',
    ...
    'BadWidth'             => 'Mauvaise valeur pour la largeur',
    ...
    'BlobPx'               => 'Px goutte',
    'BlobSizes'            => 'Tailles de goutte',
    'Blobs'                => 'Gouttes',
    'Brightness'           => 'Luminosité;',
    'Buffers'              => 'Tampons',
    'CanAutoFocus'         => 'Focus auto dispo',
    'CanAutoGain'          => 'Gain auto dispo',
    'CanAutoIris'          => 'Iris auto dispo',
    'CanAutoWhite'         => 'Bal. blancs auto dispo',
    'CanAutoZoom'          => 'Zoom auto dispo',
    'CanFocus'             => 'Focus dispo',
    'CanFocusAbs'          => 'Focus abs. dispo.',
    'CanFocusCon'          => 'Focus cont. dispo',
    'CanFocusRel'          => 'Focus rel. dispo',
    'CanGain'              => 'Gain dispo',
    'CanGainAbs'           => 'Gain abs. dispo',
    'CanGainCon'           => 'Gain cont. dispo',
    'CanGainRel'           => 'Gain rel. dispo',
    'CanIris'              => 'Iris dispo',
    'CanIrisAbs'           => 'Iris abs. dispo',
    'CanIrisCon'           => 'Iris cont. dispo',
    'CanIrisRel'           => 'Iris rel. dispo',
    'CanMove'              => 'Depl. dispo',
    'CanMoveAbs'           => 'Depl. abs. dispo',
    'CanMoveCon'           => 'Depl. cont. dispo',
    'CanMoveDiag'          => 'Depl. diag. dispo',
    'CanMoveMap'           => 'Depl. carto. dispo',
    'CanMoveRel'           => 'Depl. rel. dispo',
    'CanPan'               => 'Pano. dispo' ,
    'CanReset'             => 'RàZ dispo',
    'CanSetPresets'        => 'Def. prépos. dispo',
    'CanSleep'             => 'Veille dispo',
    'CanTilt'              => 'Incl. dispo',
    'CanWake'              => 'Réveil dispo',
    'CanWhite'             => 'Bal. blancs dispo',
    'CanWhiteAbs'          => 'Bal. blancs abs. dispo',
    'CanWhiteBal'          => 'Bal. blancs dispo',
    'CanWhiteCon'          => 'Bal. blancs cont. dispo',
    'CanWhiteRel'          => 'Bal. blancs rel. dispo',
    'CanZoom'              => 'Zoom dispo',
    'CanZoomAbs'           => 'Zoom abs. dispo',
    'CanZoomCon'           => 'Zoom cont. dispo',
    'CanZoomRel'           => 'Zoom rel. dispo',
    'Cancel'               => 'Annuler',
    ...
    'Group'                => 'Groupe',
    'Groups'               => 'Groupes',
    'HasFocusSpeed'        => 'Vitesse focus dispo',
    'HasGainSpeed'         => 'Vitesse gain dispo',
    'HasHomePreset'        => 'Prépos. par défaut dispo',
    'HasIrisSpeed'         => 'Vitesse iris dispo',
    'HasPanSpeed'          => 'Vitesse pano. dispo',
    'HasPresets'           => 'Prépos. dispo',
    'HasTiltSpeed'         => 'Vitesse incl. dispo',
    'HasTurboPan'          => 'Pano. turbo dispo',
    'HasTurboTilt'         => 'Incl. turbo dispo',
    'HasWhiteSpeed'        => 'Vitesse bal. blancs dispo',
    'HasZoomSpeed'         => 'Vitesse zoom dispo',
    'High'                 => 'Haut',
    'HighBW'               => 'Haut débit',
    'Home'                 => 'Maison',
    'Hour'                 => 'Heure',
    ...
    'MaxFocusRange'        => 'Plage focus max',
    'MaxFocusSpeed'        => 'Vitesse focus max',
    'MaxFocusStep'         => 'Pas focus max',
    'MaxGainRange'         => 'Plage gain max',
    'MaxGainSpeed'         => 'Vitesse gain max',
    'MaxGainStep'          => 'Pas gain max',
    'MaxIrisRange'         => 'Plage iris max',
    'MaxIrisSpeed'         => 'Vitesse iris max',
    'MaxIrisStep'          => 'Pas iris max',
    'MaxPanRange'          => 'Plage pano. max.',
    'MaxPanSpeed'          => 'Vitesse pano. max',
    'MaxPanStep'           => 'Pas pano. max',
    'MaxTiltRange'         => 'Plage incl. max',
    'MaxTiltSpeed'         => 'Vitesse incl. max',
    'MaxTiltStep'          => 'Pas incl. max',
    'MaxWhiteRange'        => 'Plage bal. blancs max',
    'MaxWhiteSpeed'        => 'Vit. bal. blancs max',
    'MaxWhiteStep'         => 'Pas bal. blancs max',
    'MaxZoomRange'         => 'Plage zoom max',
    'MaxZoomSpeed'         => 'Vitesse zoom max',
    ...
    'MinBlobAreaLtMax'     => 'La surface minimum des gouttes doit être inférieure au maximum',
    'MinBlobAreaUnset'     => 'Vous devez spécifier la surface minimum des gouttes (nb de pixels)',
    'MinBlobLtMinFilter'   => 'La surface minimum des gouttes doit être inférieure à la surface minimum filtrée',
    'MinBlobsLtMax'        => 'Le nombre minimum de gouttes doit être inférieur au maximum',
    'MinBlobsUnset'        => 'Vous devez spécifier le nombre minimum de gouttes',
    ...
    'MinFocusRange'        => 'Plage focus min',
    'MinFocusSpeed'        => 'Vitesse focus min',
    'MinFocusStep'         => 'Pas focus min',
    'MinGainRange'         => 'Plage gain min',
    'MinGainSpeed'         => 'Vitesse gain min',
    'MinGainStep'          => 'Pas gain min',
    'MinIrisRange'         => 'Plage iris min',
    'MinIrisSpeed'         => 'Vitesse iris min',
    'MinIrisStep'          => 'Pas iris min',
    'MinPanRange'          => 'Plage pano. min',
    'MinPanSpeed'          => 'Vitesse pano. min',
    'MinPanStep'           => 'Pas pano. min',
    ...
    'MinTiltRange'         => 'Plage incl. min',
    'MinTiltSpeed'         => 'Vitesse incl. min',
    'MinTiltStep'          => 'Pas incl. min',
    'MinWhiteRange'        => 'Plage bal. blancs min',
    'MinWhiteSpeed'        => 'Vitesse bal. blancs min',
    'MinWhiteStep'         => 'Pas bal. blancs min',
    'MinZoomRange'         => 'Plage zoom min',
    'MinZoomSpeed'         => 'Vitesse zoom min',
    ...
    'RestrictedMonitors'   => 'Caméras confid.',
    ...
    'TimestampLabelX'      => 'Etiquette X',
    'TimestampLabelY'      => 'Etiquette Y',
    'Today'                => 'Aujourd\'hui',
    'Tools'                => 'Outils',
    ...
    'TurboPanSpeed'        => 'Vitesse pano. turbo',
    'TurboTiltSpeed'       => 'Vitesse incl. turbo',
    'Type'                 => 'Type',
    ...
    'Wake'                 => 'Réveiller',
    'WarmupFrames'         => 'Nb d\'image(s) test',
    'Watch'                => 'Regarder',
    'Web'                  => 'Web',
    ...
    'ZoneFilterSize'       => 'Largeur/hauteur aire filtrée (nb pixels)',
    'ZoneMinMaxAlarmArea'  => 'Aire en alarme min/max (nb pixels)',
    'ZoneMinMaxBlobArea'   => 'Aire des gouttes min/max (nb pixels)',
    'ZoneMinMaxBlobs'      => 'Nombre de gouttes min/max',
    'ZoneMinMaxFiltArea'   => 'Aire filtrée min/max (nb pixels)',
