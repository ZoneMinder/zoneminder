...
/******************* 1.37.x **********************************/
    ...
    'Analysis images only (if available)' => 'Только аналитические изображения (если имеются)',
    'Frames + Analysis images (if available)' => 'Кадры + Аналитические изображения (если имеются)',
