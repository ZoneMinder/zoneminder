...
'ZM_LOG_DATABASE_LIMIT' => array(
    ...
    Вы также можете установить для этого значения значения времени, такие как "<n> day", что ограничит записи журнала более новыми, чем это время.~~
    Вы можете указать "hour", "day", "week", "month" и "year", при этом интервал будет соответсвовать часам, дням, неделям, месяцам или годам соответсвенно, обратите внимание, что значения должны быть единственными (без "s" в конце).~~
...
//   ****************Prompts *************************
	...
	'LOG_LEVEL_TERM' => array ( 'Prompt'=>'Сохранять логb в стандартный поток вывода'),
