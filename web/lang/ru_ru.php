...
$SLANG = array(
    ...
    'BadAnalysisUpdateDelay'=> 'Задержка обновления анализа должна быть целочисленной, больше или равной нулю', // Added - 2015-07-23
    'BadChannel'           => 'Канал должен быть целочисленным, большим или равным нулю',
    'BadColours'           => 'Неправильное цветовое пространство', // Added - 2011-06-15
    'BadDevice'            => 'Неправильный путь к устройству',
    'BadFPSReportInterval' => 'Период обновления индикации скорости должен быть целочисленным, большим или равным нулю',
    'BadFormat'            => 'Неправильный формат',
    'BadFrameSkip'         => 'Количество пропускаемых кадров должно быть целочисленным, большим или равным нулю',
    ...
    'BadLabelX'            => 'X координата ярлыка должна быть целочисленной, большей или равной нулю',
    'BadLabelY'            => 'Y координата ярлыка должна быть целочисленной, большей или равной нулю',
    'BadMaxFPS'            => 'Ограничение скорости записи должно быть положительным',
    'BadMotionFrameSkip'   => 'Количество пропускаемых кадров движения должно быть целочисленным, большим или равным нулю',
    ...
    'BadPostEventCount'    => 'Буфер после события должен быть целочисленным, больше или равным нулю',
    'BadPreEventCount'     => 'Буфер до события должен быть целочисленным, большим или равным нулю, но меньше буфера изображений',
    ...
    'BadStreamReplayBuffer'=> 'Буфер потока повторного воспроизведения должен быть целочисленным, большим или равным нулю',
    'BadWarmupCount'       => 'Кол-во кадров разогрева должно быть целочисленным, большим или равным нулю',
    ...
    'ReportEventAudit'     => 'Отчёт о событиях',    // Edited - 2019-03-24
    'Reports'              => 'Отчеты'
    'Reset'                => 'Сбросить',
...
// *********07-2022************************************ 
    ...
    'Archive Status'       => 'В архиве', // Montage Review -> type label
...
//    '2 Wide'               => '2 Columnas', // Montage -> type Dropdown menu
    ...
    'Decoder'              => 'Декодер',
    'DecoderHWAccelName'   => 'Имя ускорителя ',
    'DecoderHWAccelDevice' => 'Устройство ускорителя',
