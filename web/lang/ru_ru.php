...
// arithmetic in the database, if this is the case change only the individual locale Зонаs
...
$SLANG = array(
    ...
    'AddNewControl'        => 'Добавить управления',
    ...
    'AlarmFrameCount'      => 'Счетчик тревожных кадров',
    'AlarmLimits'          => 'Гран.&nbsp;зоны&nbsp;трев.',
    'AlarmMaximumFPS'      => 'Тревога при MAX FPS',
    'AlarmPx'              => 'Пкс&nbsp;трев.',
    'AlarmRGBUnset'        => 'Вы должны установить сигнал RGB цвета',
    'Alert'                => 'Настороже',
    'All'                  => 'Все',
    'Apply'                => 'Применить',
    ...
    'AttrName'             => 'Название',
    'AttrNotes'            => 'Заметки',
    'AttrSystemLoad'       => 'Нагрузка системы',
    'AttrTime'             => 'Время',
    'AttrTotalScore'       => 'Сумм. оценка',
    'AttrWeekday'          => 'День недели',
    'Auto'                 => 'Автоматически',
    'AutoStopTimeout'      => 'Автоматическая остановка по оканчании ',
    ...
    'MinAlarmЗонаLtMax'    => 'Minimum alarm Зона should be less than maximum',
    'MinAlarmЗонаUnset'    => 'You must specify the minimum alarm pixel count',
    'MinBlobЗонаLtMax'     => 'Минимальная площадь объекта должна быть меньше чем максимальная площадь объекта',
    'MinBlobЗонаUnset'     => 'You must specify the minimum blob pixel count',
    'MinBlobLtMinFilter'   => 'Minimum blob Зона should be less than or equal to minimum filter Зона',
    ...
    'MinFilterЗонаLtMax'   => 'Minimum filter Зона should be less than maximum',
    'MinFilterЗонаUnset'   => 'You must specify the minimum filter pixel count',
    'MinFilterLtMinAlarm'  => 'Minimum filter Зона should be less than or equal to minimum alarm Зона',
    ...
    'SignalCheckColour'    => 'Проверка цветности сигнала'
    'Size'                 => 'Размер'
    'SkinDescription'      => 'Изменение оболочки по умолчанию для данного компьютера', // Added - 2011-01-30
    'Sleep'                => 'Сон',
    'SortAsc'              => 'Asc',
    'SortBy'               => 'Сортировать:',
    'SortDesc'             => 'Desc',
    'Source'               => 'Источник',
    'SourceColours'        => 'Исходные Цвета',         // Added - 2009-02-08
    'SourcePath'           => 'Исходный путь',            // Added - 2009-02-08
    'SourceType'           => 'Тип источника',
    'Speed'                => 'Скорость',
    'SpeedHigh'            => 'Высокоскоростной',
    'SpeedLow'             => 'Низкоскоростной',
    'SpeedMedium'          => 'Среднескоростной',
    'SpeedTurbo'           => 'Турбоскоростной',
    'Start'                => 'Запустить',
    'State'                => 'Состояние',
    'Stats'                => 'Статистика',
    'Status'               => 'Статус',
    ...
    'Stopped'              => 'Остановлен',
    'Stream'               => 'Поток',
    'StreamReplayBuffer'   => 'Поток Replay буфера изображения',
    'Submit'               => 'Отправить',
    'System'               => 'Система',
    'SystemLog'            => 'ЛОГ',             // Added - 2011-06-16
    'Tele'                 => 'телевизионный',
    'Thumbnail'            => 'Эскиз',
    'Tilt'                 => 'Наклон',
    'Time'                 => 'Время',
    ...
    'TrackDelay'           => 'Задержка дорожки',
    'TrackMotion'          => 'Дорожка движения',
    'Triggers'             => 'Триггеры',
    'TurboPanSpeed'        => 'Turbo Pan Speed',
    'TurboTiltSpeed'       => 'Turbo Tilt Speed',
    'Type'                 => 'Тип',
    'Unarchive'            => 'Уд.&nbsp;из&nbsp;архива',
    'Undefined'            => 'Неопределенный',              // Added - 2009-02-08
    'Units'                => 'Ед. измерения',
    'Unknown'              => 'Неизвестный',
    'Update'               => 'Обновить',
    ...
    'UsedPlugins'	   => 'Подключаемые модули',
    ...
    'VideoGenSucceeded'    => 'Генерация видео файла произведена!',
    'VideoSize'            => 'Размер изображения',
    'View'                 => 'Просмотр',
    'ViewAll'              => 'Просм. все',
    'ViewEvent'            => 'Просмотр событий',
    ...
    'ZoneЗона'             => 'Зона полигона',
    'ZoneFilterSize'       => 'Фильтр Ширина / Высота (пикселей)',
    'ZoneMinMaxAlarmЗона'  => 'Min / Max Тревожная Площадь',
    'ZoneMinMaxBlobЗона'   => 'Min / Max отмеченная Площадь',
    'ZoneMinMaxBlobs'      => 'Min / Max отметок',
    'ZoneMinMaxFiltЗона'   => 'Min / Max Фильтрованных зон',
    'ZoneMinMaxPixelThres' => 'Min / Max Pixel Threshold (0-255)',
    'ZoneMinderLog'        => 'ЛОГ ZoneMinder',         // Added - 2011-06-17
    'ZoneOverloadFrames'   => 'Игнорирование перегрузки счетчика кадров',
    'Zones'                => 'Зоны',
    'Zoom'                 => 'Zoom',
    'ZoomIn'               => 'Zoom +',
    'ZoomOut'              => 'Zoom -',
...
// In this section you can override the default prompt and help texts for the options Зона
