...
// setlocale( LC_ALL,   'zh_TW' ); All locale settings 4.3.0 and after
// setlocale( LC_CTYPE, 'zh_TW' ); Character class settings 4.3.0 and after
// setlocale( LC_TIME,  'zh_TW' ); Date and time formatting 4.3.0 and after
