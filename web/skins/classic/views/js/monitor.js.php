...
*/
  ...
  if ( form.elements['newMonitor[Type]'].value != 'WebSite' ) {
    ...
    if (form.elements['newMonitor[MaxImageBufferCount]'].value && (parseInt(form.elements['newMonitor[PreEventCount]'].value) > parseInt(form.elements['newMonitor[MaxImageBufferCount]'].value)))
