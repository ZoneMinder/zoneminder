      ...
      <div id="sizeControl">
        <form action="?view=montage" method="post">
          ...
          <span id="widthControl">
            ...
            <?php echo htmlSelect('width', $widths, $options['width'], array('id'=>'width', 'data-on-change-this'=>'changeWidth')); ?>
          </span>
          <span id="heightControl">
            <label><?php echo translate('Height') ?></label>
            <?php echo htmlSelect('height', $heights, $options['height'], array('id'=>'height', 'data-on-change-this'=>'changeHeight')); ?>
          </span>
