...
?>
      ...
      <div id="sizeControl">
        ...
        <span id="streamQualityControl">
          ...
          <?php
              echo htmlSelect('streamChannel', ZM\Monitor::getRTSP2WebStreamOptions($monitor->Id()), $monitor->RTSP2WebStream(), array('data-on-change'=>'monitorChangeStreamChannel','id'=>'streamChannel'));
