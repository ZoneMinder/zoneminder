...
$zmSlangAutoArchiveAbbr      = '存檔';
$zmSlangAutoArchiveEvents    = '自動儲存符合項目';
$zmSlangAutoDeleteAbbr       = '刪除';
$zmSlangAutoDeleteEvents     = '自動刪除符合項目';
$zmSlangAuto                 = '自動';
$zmSlangAutoEmailAbbr        = '郵寄';
$zmSlangAutoEmailEvents      = '自動寄出詳細符合項目';
$zmSlangAutoExecuteAbbr      = '執行';
$zmSlangAutoExecuteEvents    = '自動執行符合指令';
$zmSlangAutoMessageAbbr      = '訊息';
$zmSlangAutoMessageEvents    = '自動發出符合訊息';
$zmSlangAutoStopTimeout      = '時間過自動停止';
$zmSlangAutoUploadAbbr       = '上傳';
$zmSlangAutoUploadEvents     = '自動上傳符合項目';
$zmSlangAutoVideoAbbr        = '影像';
$zmSlangAutoVideoEvents      = '自動產生符合的影像檔';
