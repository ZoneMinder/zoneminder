...
$zmSlangAutoArchiveEvents    = 'Automaticky archivovat v¹echny nalezené';
$zmSlangAuto                 = 'Auto';
$zmSlangAutoDeleteEvents     = 'Automaticky smazat v¹echny nalezené';
$zmSlangAutoEmailEvents      = 'Automaticky poslat email s detaily nalezených';
$zmSlangAutoExecuteEvents    = 'Automaticky spustit pøíkaz na v¹ech nalezených';
$zmSlangAutoMessageEvents    = 'Automaticky podat zprávu o v¹ech nalezených';
...
$zmSlangDeviceFormat         = 'Formát zaøízení (0=PAL,1=NTSC etc)';
$zmSlangDeviceNumber         = 'Èíslo zarízení (/dev/video?)';
...
$zmSlangMinAlarmGeMinBlob    = 'Minimum alarm pixelù by mìlo být vìt¹í nebo rovno minimu znaèkovaných pixelù';
$zmSlangMinAlarmGeMinFilter  = 'Minimum alarm pixelù by mìlo být vìt¹í nebo rovno minimu filtr pixelù';
$zmSlangMinAlarmPixelsLtMax  = 'Minimum alarm pixelù by mìlo být men¹í ne¾ maximum alarm pixelù';
$zmSlangMinBlobAreaLtMax     = 'Minimum znaèkované oblasti by mìlo být men¹í ne¾  maximum znaèkované oblasti';
$zmSlangMinBlobsLtMax        = 'Minimum znaèek by mìlo být men¹í ne¾ maximum znaèek';
$zmSlangMinFilterPixelsLtMax = 'Minimum filtr pixelù by mìlo být men¹í ne¾ maximum filtr pixelù';
...
$zmSlangMinPixelThresLtMax   = 'Minimální práh pixelu by mìl být men¹í ne¾  maximumální práh pixelu';
...
$zmSlangNoGroups             = '®ádné skupiny nebyly definovány';
...
$zmSlangZoneFilterHeight     = 'Vý¹ka filtru (pixely)';
$zmSlangZoneFilterWidth      = '©íøka filtru (pixely)';
$zmSlangZoneMaxAlarmedArea   = 'Maximální zasa¾ená oblast';
$zmSlangZoneMaxBlobArea      = 'Maximální znaèkovaná oblast';
$zmSlangZoneMaxBlobs         = 'Maximum znaèek';
$zmSlangZoneMaxFilteredArea  = 'Maximální filtrovaná oblast';
$zmSlangZoneMaxPixelThres    = 'Maximální práh pixelu (0-255)';
$zmSlangZoneMaxX             = 'Maximum X (vpravo)';
$zmSlangZoneMaxY             = 'Maximum Y (dole)';
$zmSlangZoneMinAlarmedArea   = 'Minimální zasa¾ená oblast';
$zmSlangZoneMinBlobArea      = 'Minimální znaèkovaná oblast';
$zmSlangZoneMinBlobs         = 'Minimum znaèek';
...
$zmSlangZoneMinY             = 'Minimum Y (nahoøe)';
$zmSlangZones                = 'Zóny';
$zmSlangZone                 = 'Zóna';
