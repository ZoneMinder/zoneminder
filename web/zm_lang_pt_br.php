...
$zmSlangDeviceFormat         = 'Formato do Dispos.';
$zmSlangDeviceNumber         = 'Num. do Dispos.';
...
$zmSlangError                = 'Erro';
$zmSlangErrorValidValue      = 'Erro, por favor cheque se os campos estão corretos';
$zmSlangEtc                  = 'etc';
$zmSlangEvent                = 'Evento';
...
$zmSlangOpNotIn              = 'não no set';
$zmSlangOpNotMatches         = 'não combina';
...
$zmSlangRefImageBlendPct     = 'Referência de imagem Blend %ge';
...
$zmSlangRunState             = 'Estado de Execução';
...
$zmSlangUsername             = 'Nome de Usuário';
$zmSlangUsers                = 'Usuários';
$zmSlangUser                 = 'Usuário';
$zmSlangValue                = 'Valor';
$zmSlangVersionIgnore        = 'Ignorar esta versão';
...
$zmClangLastEvents           = 'Últimos %1$s %2$s'; // For example 'Last 37 Events' (from Vlang below)
$zmClangLatestRelease        = 'A Última versão é v%1$s, você tem v%2$s.';
$zmClangMonitorCount         = '%1$s %2$s'; // For example '4 Monitors' (from Vlang below)
$zmClangMonitorFunction      = 'Monitor %1$s Funcção';
$zmClangRunningRecentVer     = 'Você está usando a versão mais recente do ZoneMinder, v%s.';
